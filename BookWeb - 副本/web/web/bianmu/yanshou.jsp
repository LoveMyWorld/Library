...
<div class="sidebar">
          <div>
              ...
              <a href="javascript:void(0);" onclick="location.href='${pageContext.request.contextPath}/catalogManagementServlet'">编目管理</a>
              <a href="javascript:void(0);" onclick="location.href='${pageContext.request.contextPath}/YanshouServlet'">验收清单</a>
              <a href="javascript:void(0);" onclick="location.href='${pageContext.request.contextPath}/damageServlet'">报损</a>
          </div>
<%--      改--%>
  <!-- 底部横杠和关于我们按钮 -->
