            ...
            document.addEventListener("DOMContentLoaded", function() {
                ...
                reviewButtons.forEach(function(button) {
                    button.addEventListener("click", function(event) {
                        ...
                        // 保存当前的apID以便后续使用
                        document.getElementById("confirmModal").dataset.apID = apID;
                    });
                });
                ...
                confirmDamagedButton.addEventListener("click", function() {
                    var apID = document.getElementById("confirmModal").dataset.apID;
                    sendReviewData(apID, true);
                });
                ...
                confirmNotDamagedButton.addEventListener("click", function() {
                    var apID = document.getElementById("confirmModal").dataset.apID;
                    sendReviewData(apID, false);
                });
            });

            function sendReviewData(apID, isDamaged) {
                $.ajax({
                    url: '${pageContext.request.contextPath}/CheckAppointmentServlet',  // 后端接口
                    method: 'POST',
                    data: {
                        apID: apID,
                        isDamaged: isDamaged
