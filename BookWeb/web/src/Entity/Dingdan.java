...
public class Dingdan {
    ...
    public Dingdan(String orderName, String supplier, String title, String publisher, String orderPerson, String ISBN, DocumentType documentType, double price, int currencyID, String edition, String printingHouse, String author, boolean isBianmu) {
    ...
    public Dingdan(String supplier, String orderName, String title, String publisher, String orderPerson, String receiver, String ISBN, DocumentType documentType, int currencyID, double price, String edition, String printingHouse, LocalDate publicationDate, int subscribeNum, String author, boolean isBianmu) {
        this.supplier = supplier;
        this.orderName = orderName;
        this.title = title;
        this.publisher = publisher;
