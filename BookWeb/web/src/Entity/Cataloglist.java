...
public class Cataloglist {
    ...
    private String categoryID;//图书分类号
...
//    private String printingHouse; // 印刷厂
    ...
    public Cataloglist(String bookID, String title, String categoryID, String author, String ISBN, LocalDate publicationDate, String publisher, String edition, String supplier, int currencyID, double price, String orderPerson, String receiver, int bookNum, DocumentType documentType) {
        this.bookID = bookID;
        this.title = title;
